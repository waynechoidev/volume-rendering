...
This final stage keeps the discrete volume rendering equation and 3D density
texture from stage 05, then adds density-gradient lighting and a short
secondary march toward the light. Its primary purpose is to show how visual
shading can be layered on top of physically meaningful transmittance without
changing the camera-ray compositing equation.

## What this stage adds

- A connected cloud-like density field instead of one ellipsoid.
- Forward differences of density to estimate \(\nabla\rho\).
- A normalized pseudo-normal \(-\nabla\rho/\|\nabla\rho\|\).
- A short light-ray optical-depth estimate.
- Curvature, powder, and view–light artistic terms.

The lighting is intentionally approximate. The core volume integral remains
the same equation derived in stage 04.
